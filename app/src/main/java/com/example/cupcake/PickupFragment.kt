...
//
//    val dpd = DatePickerDialog(activity, DatePickerDialog.OnDateSetListener{view, year, monthOfYear,
//        dayOfMonth -> lblDate.setText(""+dayOfMonth+" "+MONTHS+", "+year)}, year, month, day))
//
//    dpd.show()
    /**
